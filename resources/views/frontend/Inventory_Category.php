        ...
        <div class="inner-wrapper">
            ...
            <div id="main">
                <div class="breadcrumb"><!-- *BreadCrumb Starts here** -->
                    <div class="container">
                        <h2>INVENTORY<span>CATEGORY</span></h2>
                ...
                <div class="container">
                    ...
                    <!-- <a onclick="toggleCategoryItem()" class="dt-sc-button small type1" style="float: right;">+</a><div class="clear"> </div> -->
                    <div class="dt-sc-tabs-container">
                        <ul class="dt-sc-tabs-frame">
                            <li><a href="#" class="current categoryTable"> Category </a></li>
                            <li><a href="#" class="itemTable"> Items </a></li>
                            <div id="plusToggleContent">
                                <a class="dt-sc-button small type1 addCategory " style="float: right; display: inline-block">Add Category</a><div class="clear"> </div>
                                <a class="dt-sc-button small type1 addItem " style="float: right; display: none; margin-top: -56px;">Add Item</a><div class="clear"> </div>
                            </div>
                        </ul>
