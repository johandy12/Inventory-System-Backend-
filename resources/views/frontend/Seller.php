        ...
        <div class="inner-wrapper">
            ...
            <div id="main">
                ...
                <div class="container">
                    ...
                    <!-- ISI KODE DISINI -->
                    <label for="sales_search"><h4> SELLER HISTORY </h4></label>
                    <div class="selection-box">
                        <select name="billing_city" class="shop-dropdown" >
                            <option value="-1" selected>-- Select Seller --</option>
                            <option value="Kenny" class="">Kenny</option>
                            <option value="Tamil" class="">Tamil</option>
                            <option value="Wayne" class="">Wayne</option>
                            <option value="Bruce" class="">Bruce</option>
                            <option value="John" class="">John</option>
                        </select>
                    </div>
                    <br>
                    <br>
