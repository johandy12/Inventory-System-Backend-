        ...
        <div class="inner-wrapper">
                                ...
                                <ul class="menu type3">
                                    ...
                                    <li class="current_page_item menu-item-simple-parent"><a href="#">Blog Page <span class="arrow"></span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current_page_item"><a href="blog-detail-with-rhs.html">Blog-detail-right-sidebar</a></li>
                                        </ul>
                                    </li>
            ...
            <div id="main">
                <div class="breadcrumb"><!-- *BreadCrumb Starts here** -->
                    <div class="container">
                        <h2>Blog Detail With <span>Right Sidebar</span></h2>
                ...
                <div class="container">
                    ...
                    <section id="primary" class="with-sidebar with-right-sidebar"> <!-- **Primary Starts Here** -->
                    ...
                    </section><!-- **Primary Starts Here** -->
                    <section id="secondary" class="secondary-sidebar secondary-has-right-sidebar"><!-- **Secondary Starts Here** -->
