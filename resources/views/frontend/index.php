...
<body>
                ...
                <header class="slide-bar">
                    <div class="header-container">
                        <div class="header-inner">
                            ...
                            <nav>
                                <ul class="menu type3">
                                    <li class="current_page_item menu-item-simple-parent"><a href="#">Home Page <span class="arrow"></span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current_page_item"><a href="http://www.wedesignthemes.com/html/redart/slide-bar">Slide Bar</a></li>
                        ...
                        <div class="container">
                            ...
                            <div class="about-section">
                                ...
                                <div class="dt-sc-one-half column first">
                                    <img src="/public/frontend/js/images/about.png" title="" alt="">
                                </div>
    ...
    <script src="public/frontend/js/plugins/jquery.tipTip.minified.js" type="text/javascript"></script>    
