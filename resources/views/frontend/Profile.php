...
<body>
            ...
            <div id="main">
                ...
                <div class="container">
                    ...
                    <div class="post-author-details">
                        <div class="entry-author-image" style="margin-right:100px auto;">
                            <img src="http://placehold.it/100x100&text=Author" alt="" title="" style="width: 180px; height: 180px;" />
                        </div>
                        <div class="author-title">
                            <h5>Name : James Dean</h5>
                            <span>Gender : Male</span>
                            <span>Address : West Jakarta, Jl.random</span>
                            <span>E-mail : test@gmail.com</span>
                            <span>Mobile Number : 08222111333</span>
                            <span>Job : Student</span>
                            <a class="dt-sc-button type3 small" style="margin-top: 10px;" >Edit Profile</a>
                            <a class="dt-sc-button type3 small" style="margin-top: 10px;" >Change Password</a>
                        </div>               
                    </div>
    ...
    <script src="public/frontend/js/plugins/custom.js"                              type="text/javascript"></script>
