...
<body>
                            ...
                            <nav>
                                <ul class="menu type3">
                                    ...
                                    <li class="current_page_item menu-item-simple-parent"><a href="#">Shop Page <span class="arrow"></span></a>
                                        <ul class="sub-menu">
                                            <li class="current_page_item"><a href="shop.html">Shop</a></li>
                        ...
                        <ul class="products isotope">
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                ...
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x300&text=Product+Image+1" alt="image"/> </div> </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/577x800&text=Product+Image+2" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/500x340&text=Product+Image+3" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/500x400&text=Product+Image+4" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/2500x1724&text=Product+Image+5" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x350&text=Product+Image+6" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x500&text=Product+Image+7" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x400&text=Product+Image+8" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x400&text=Product+Image+9" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x300&text=Product+Image+10" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x750&text=Product+Image+11" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x500&text=Product+Image+12" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x740&text=Product+Image+13" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/600x600&text=Product+Image+14" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
                            ...
                            <li class="product-wrapper dt-sc-one-fifth"> <!-- **product-wrapper - Starts** -->
                                <!-- **product-container - Starts** -->   
                                <div class="product-container">
                                    <a href="shop-detail.html"><div class="product-thumb"> <img src="http://placehold.it/700x500&text=Product+Image+15" alt="image"/> </div> </a>
                                    <!-- **product-title - Starts** -->
                                    <div class="product-title"> 
                                        <a href="shop-cart.html" class="type1 dt-sc-button"> <span class="fa fa-shopping-cart"></span> Add to Cart </a>
                                        <a href="#" class="type1 dt-sc-button"> <span class="fa fa-unlink"></span> Options </a>
    ...
    <script type="text/javascript" src="public/frontend/js/plugins/jquery.isotope.min.js"></script>
    <script type="text/javascript" src="public/frontend/js/plugins/jquery.isotope.perfectmasonry.min.js"></script>
	<script type="text/javascript" src="public/frontend/js/plugins/jquery.dropdown.js"></script>      
