...
<body>
        ...
        <div class="inner-wrapper">
                                ...
                                <ul class="menu type3">
                                    ...
                                    <li class="current_page_item menu-item-simple-parent"><a href="#">Blog Page <span class="arrow"></span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current_page_item"><a href="blog-detail-with-lhs.html">Blog-detail-left-sidebar</a></li>
            ...
            <div id="main">
                <div class="breadcrumb"><!-- *BreadCrumb Starts here** -->
                    <div class="container">
                        <h2>Blog Detail With <span>Left Sidebar</span></h2>
                ...
                <div class="container">
                    ...
                    <section id="secondary" class="secondary-sidebar secondary-has-left-sidebar"><!-- **Secondary Starts Here** -->
                        ...
                        <aside class="widget widget_popular_entries">
                            ...
                            <div class="recent-gallery-widget">
                                <ul>
                                    <li>
                                        <a class="entry-thumb" href="#"><img alt="Enjoy Life with Family" src="http://placehold.it/955x470&text=Blog+Image"></a>
                        ...
                        <aside class="widget widget_archive">
                            ...
                            <ul>
                                <li><a href="#">Apr 2014<span> 5</span></a></li>
                                <li><a href="#">Aug 2014<span> 8</span></a></li>
                                <li><a href="#">Nov 2014<span> 3</span></a></li>
                                <li><a href="#">Jan 2015<span> 4</span></a></li>
                                <li><a href="#">Feb 2015<span> 2</span></a></li>
                            </ul>
                        </aside>
                    ...
                    <section id="primary" class="with-sidebar with-left-sidebar"> <!-- **Primary Starts Here** -->
    ...
    <!-- **jQuery** -->  
	<script src="public/frontend/js/jquery-1.11.2.min.js" type="text/javascript"></script>
	<script src="public/frontend/js/jquery.tabs.min.js"></script>
	<script src="public/frontend/js/jquery-migrate.min.js" type="text/javascript"></script>
	<script src="public/frontend/js/jquery.validate.min.js" type="text/javascript"></script>    
	<script src="public/frontend/js/jsplugins.js" type="text/javascript"></script>    
    <script src="public/frontend/js/custom-scroll/mCustomScrollbar.min.js" type="text/javascript"></script>
