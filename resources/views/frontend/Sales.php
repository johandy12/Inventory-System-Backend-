        ...
        <div class="inner-wrapper">
            ...
            <div id="main">
                ...
                <div class="container">
                    ...
                    <!-- ISI KODE DISINI -->
                    <label for="sales_search"><h4> SALES HISTORY </h4></label>
                    <input type="text" class="input-text" name="sales_search" id="salesSearch" placeholder="Search Sales History.." value="" style="width: 400px;">
                    <a href="#"><button class="button" style="width: 100px;"><i class="fa fa-search"></i></button></a>
                    <br>
                    <br>
