...
<head>
    ...
    <link href="../node_modules/chart.js/dist/Chart.min.css" rel="stylesheet" type="text/css">   
        ...
        <div class="inner-wrapper">
                    ...
                    <div class="header-container">
                        <div class="header-inner">
                            ...
                            <a href="index.html" class="logo-container">
                                ...
                                <img src="images/BabelacImg/linkedin_banner_image_1_2.jpg" alt="" >
                                <!-- <img src="images/BabelacImg/twitter_profile_image2.jpg" alt="" > -->
                            </a>
                            <nav>
                                <ul class="menu type3">
            ...
            <div id="main">
                ...
                <div class="container">
                    ...
                    <!-- ISI KODE DISINI -->
                    <label for="Job-Inventory"><h3> Inventory </h3></label>
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Get Inventory</a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Add Inventory</a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Update Item</a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Delete Item</a></div>
                    </div>
                    <br>
                    <label for="Job-Sales"><h3> Sales </h3></label>
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Get Sales</a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Add Sales</a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Update Sales</a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 marginBottomApply"><a class="dt-sc-button large type3 " style="width: 100%;" href="#">Delete Item</a></div>
                    </div>
