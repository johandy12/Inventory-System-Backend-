...
<body>
                                ...
                                <ul class="menu type3">
                                    ...
                                    <li class="current_page_item menu-item-simple-parent"><a href="#">Gallery Page <span class="arrow"></span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current_page_item"><a href="gallery-detail-with-rhs.html">Gallery-detail-right-sidebar</a></li>
                                        </ul>
                                    </li>
            ...
            <div id="main">
                <div class="breadcrumb"><!-- *BreadCrumb Starts here** -->
                    <div class="container"><!-- **Container Starts Here** -->
                        <h2>Gallery Detail With <span>Right Sidebar</span></h2>
	...
	<script src="public/frontend/js/plugins/jquery.prettyPhoto.js" type="text/javascript"></script>    
	<script src="public/frontend/js/plugins/jquery.validate.min.js" type="text/javascript"></script>
	<script src="public/frontend/js/plugins/jquery.bxslider.min.js" type="text/javascript"></script>        
